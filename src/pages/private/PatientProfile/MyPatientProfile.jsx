...
import { createPatientProfile } from "../../../services/patientService"; // Ajusta la ruta si es necesario
...
export default function PatientProfileSetup() {
  ...
  // Modificado para usar FormData y el servicio
            ...
            />
             ...
             <div className={styles.group}>
                ...
                <select
                    ...
                    {...register("gender")}
                    className={`${styles.select} ${errors.gender ? styles.errorBorder : ''}`} // Añade clase de error si es necesario
                >
